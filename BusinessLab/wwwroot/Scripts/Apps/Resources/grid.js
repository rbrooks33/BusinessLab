...
Apps.Define(['./util.js'], function (Util) {
    var Me = {
        ...
        ChangeCallback: function (callback, td) {
                            ...
                            if (col.hidden === undefined || col.hidden === false) {
                                ...
                                switch (viewtype) {
                                    ...
                                    case 'date':
                                        ...
                                        viewSpan = '<input type="date" class="grid_view_span" onchange="Apps.Grids.ChangeCallback(' + viewchange + ',$(this).parent())" title="' + tooltip(Me.RowData) + '" value="' + fieldValue + '" />';
                                        break;
                                ...
                                if (field.saveclick)
                                    editSpan += '      onclick="Apps.Grids.SaveCallback(' + field.saveclick.toString() + ', $(this).parent().parent().parent(),' + settings.savecallback.toString() + ', \'' + field.name + '\')" ';
                                editSpan += '   />';
